 ...
 */
export const toRelativeAmount = async amount => amount / (10 ** process.env.NEXT_PUBLIC_DIVISIBILITY);
 ...
 */
export const toAbsoluteAmount = async amount => amount * (10 ** process.env.NEXT_PUBLIC_DIVISIBILITY);
